...
import com.bigpumpkin.app.ddng_android.bean.City;
import com.bigpumpkin.app.ddng_android.bean.YwpAddressBean;
...
public class AddressPickerView extends RelativeLayout implements View.OnClickListener {
    ...
    private int defaultSelectedColor = Color.parseColor("#FF343434");
    ...
    // 确定字体可以点击时候的颜色
    private int defaultSureCanClickColor = Color.parseColor("#007AFF");
    ...
    private List<City.CountryBean> countryBeans;

    private AddressAdapter mAdapter;   // recyclerview 的 adapter
    private City city; // 总数据
    ...
    public interface OnAddressPickerSureListener {
        void onSureClick(String sheng, String shi, String qu, String provinceCode, String cityCode, String districtCode);
    }
