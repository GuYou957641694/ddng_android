...
public class CityPickers implements CanShow, OnWheelChangedListener {
    ...
    private CityPickers(CityPickers.Builder builder) {
    ...
    public static class Builder {
         ...
         * @return
         */
        public CityPickers.Builder titleBackgroundColor(String colorBg){
         ...
         * @return
         */
        public CityPickers.Builder title(String mtitle){
            this.mTitle=mtitle;
            return this;
        }
         ...
         * @return
         */
        public CityPickers.Builder onlyShowProvinceAndCity(boolean flag) {
         ...
         * @return
         */
        public CityPickers.Builder province(String defaultProvinceName) {
         ...
         * @return
         */
        public CityPickers.Builder city(String defaultCityName) {
         ...
         * @return
         */
        public CityPickers.Builder district(String defaultDistrict) {
         ...
         * @return
         */
        public CityPickers.Builder confirTextColor(String color) {
         ...
         * @return
         */
        public CityPickers.Builder cancelTextColor(String color) {
         ...
         * @return
         */
        public CityPickers.Builder textColor(int textColor) {
         ...
         * @return
         */
        public CityPickers.Builder textSize(int textSize) {
         ...
         * @return
         */
        public CityPickers.Builder visibleItemsCount(int visibleItems) {
         ...
         * @return
         */
        public CityPickers.Builder provinceCyclic(boolean isProvinceCyclic) {
         ...
         * @return
         */
        public CityPickers.Builder cityCyclic(boolean isCityCyclic) {
         ...
         * @return
         */
        public CityPickers.Builder districtCyclic(boolean isDistrictCyclic) {
         ...
         * @return
         */
        public CityPickers.Builder itemPadding(int itemPadding) {
            this.padding = itemPadding;
            return this;
        }

        public CityPickers build() {
            CityPickers cityPicker = new CityPickers(this);
            return cityPicker;
        }
