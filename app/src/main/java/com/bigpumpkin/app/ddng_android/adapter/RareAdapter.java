...
public class RareAdapter extends RecyclerView.Adapter<RareAdapter.MyViewHolder> {

    private List<RareBean.DataBean> data1;
    private Context context;

    public RareAdapter(List<RareBean.DataBean> data1, Context context) {
        this.data1 = data1;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        //获取相应的布局
        View view = LayoutInflater.from(context).inflate(R.layout.rare_item, viewGroup, false);
        final RareAdapter.MyViewHolder holder = new RareAdapter.MyViewHolder(view);
        return holder;
    }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            int heigh = (int) (Math.random() * 301 + 300);
            params.height = heigh;
