...
public class FruitAdapter extends RecyclerView.Adapter<FruitAdapter.MyViewHolder> {
    ...
    public FruitAdapter(List<Fruit_Bean.DataBean> data1, Context context) {
        this.data1 = data1;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        //获取相应的布局
        View view = LayoutInflater.from(context).inflate(R.layout.fruititem, viewGroup, false);
        final FruitAdapter.MyViewHolder holder = new FruitAdapter.MyViewHolder(view);
        return holder;
    }
