...
import com.bigpumpkin.app.ddng_android.bean.FreshBean;
...
public class FreshAdapter extends RecyclerView.Adapter<FreshAdapter.MyViewHolder> {
    ...
    private   List<FreshBean.DataBean.ShopBean> shop;

    public FreshAdapter(Context context, List<FreshBean.DataBean.ShopBean> shop) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        //获取相应的布局
        View view = LayoutInflater.from(context).inflate(R.layout.fresh_item, viewGroup, false);
        final FreshAdapter.MyViewHolder holder = new FreshAdapter.MyViewHolder(view);
        return holder;
    }
