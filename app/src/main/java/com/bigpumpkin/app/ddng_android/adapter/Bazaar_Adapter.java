...
public class Bazaar_Adapter extends RecyclerView.Adapter<Bazaar_Adapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        //获取相应的布局
        View view = LayoutInflater.from(context).inflate(R.layout.bazaar_itme, viewGroup, false);
        final Bazaar_Adapter.MyViewHolder holder = new Bazaar_Adapter.MyViewHolder(view);
        return holder;
    }
