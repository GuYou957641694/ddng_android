...
public class MeatAdapter extends RecyclerView.Adapter<MeatAdapter.MyViewHolder> {
    ...
    private List<MeatBean.DataBean.ShopBean> shop;

    public MeatAdapter(Context context, List<MeatBean.DataBean.ShopBean> shop) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        //获取相应的布局
        View view = LayoutInflater.from(context).inflate(R.layout.meat_item, viewGroup, false);
        final MeatAdapter.MyViewHolder holder = new MeatAdapter.MyViewHolder(view);
        return holder;
    }
