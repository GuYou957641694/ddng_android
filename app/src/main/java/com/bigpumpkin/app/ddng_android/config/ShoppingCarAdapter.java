package com.bigpumpkin.app.ddng_android.config;
...
import com.bigpumpkin.app.ddng_android.activity.BuyActivity;
import com.bigpumpkin.app.ddng_android.activity.Details_farmActivity;
...
public class ShoppingCarAdapter extends BaseExpandableListAdapter {
    ...
    public ShoppingCarAdapter(Context context, Button btnOrder, List<Shopping_Bean.DataBean> data, ImageView llSelectAll, TextView tvTotalPrice, TextView btnDelete) {
    ...
    public View getGroupView(final int groupPosition, final boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        groupViewHolder.tvStoreName.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                IntentUtils.getIntents().Intent(context, Details_farmActivity.class, null);
            }
        });
        ...
        btnOrder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (temp != null && temp.size() > 0) {//如果有被选中的
                    ...
                    IntentUtils.getIntents().Intent(context, BuyActivity.class, bundle);
                } else {
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        //店铺名称
        String store_name = datasBean.getTitle();
        //店铺是否在购物车中被选中
        ...
        /*if (childPosition == data.get(groupPosition).getList().size() - 1) {
