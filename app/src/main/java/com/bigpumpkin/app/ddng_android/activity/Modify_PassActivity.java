...
public class Modify_PassActivity extends BaseActivity implements MyView, CountDownTextUtils.CountDownListener {
    ...
    public int intiLayout() {
        return R.layout.activity_modify__pass;
    }
        ...
        switch (view.getId()) {
            case R.id.btn_change_password_get_code:
                ...
                if (isChinaPhoneLegal(mobile)) {
                    ...
                    ToastUtil.showShort(Modify_PassActivity.this, "请重新输入手机号");
                }
                break;
            case R.id.btn_login_confirm:
                ...
                if (EmptyUtils.isNotEmpty(s)) {
                    ...
                    ToastUtil.showShort(Modify_PassActivity.this, "请输入手机号");
                }
                break;
        }
    }
